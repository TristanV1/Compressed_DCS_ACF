...
parameter n_delta_address_1 = $rtoi($ceil(fs*delayTime_1)); 
parameter n_delta_address_2 = $rtoi($ceil(fs*delayTime_2));
parameter n_delta_address_3 = $rtoi($ceil(fs*delayTime_3));
parameter n_delta_address_4 = $rtoi($ceil(fs*delayTime_4));
parameter n_delta_address_5 = $rtoi($ceil(fs*delayTime_5));
parameter n_delta_address_6 = $rtoi($ceil(fs*delayTime_6));
parameter n_delta_address_7 = $rtoi($ceil(fs*delayTime_7));
parameter n_delta_address_8 = $rtoi($ceil(fs*delayTime_8));
parameter n_delta_address_9 = $rtoi($ceil(fs*delayTime_9));
parameter n_delta_address_10 = $rtoi($ceil(fs*delayTime_10));
parameter n_delta_address_11 = $rtoi($ceil(fs*delayTime_11));
parameter n_delta_address_12 = $rtoi($ceil(fs*delayTime_12));
parameter n_delta_address_13 = $rtoi($ceil(fs*delayTime_13));
parameter n_delta_address_14 = $rtoi($ceil(fs*delayTime_14));
parameter n_delta_address_15 = $rtoi($ceil(fs*delayTime_15));
parameter n_delta_address_16 = $rtoi($ceil(fs*delayTime_16));
parameter n_delta_address_17 = $rtoi($ceil(fs*delayTime_17));
parameter n_delta_address_18 = $rtoi($ceil(fs*delayTime_18));
parameter n_delta_address_19 = $rtoi($ceil(fs*delayTime_19));
parameter n_delta_address_20 = $rtoi($ceil(fs*delayTime_20));
parameter n_delta_address_21 = $rtoi($ceil(fs*delayTime_21));
parameter n_delta_address_22 = $rtoi($ceil(fs*delayTime_22));
parameter n_delta_address_23 = $rtoi($ceil(fs*delayTime_23));
parameter n_delta_address_24 = $rtoi($ceil(fs*delayTime_24));
parameter n_delta_address_25 = $rtoi($ceil(fs*delayTime_25));
parameter n_delta_address_26 = $rtoi($ceil(fs*delayTime_26));
parameter n_delta_address_27 = $rtoi($ceil(fs*delayTime_27));
parameter n_delta_address_28 = $rtoi($ceil(fs*delayTime_28));
parameter n_delta_address_29 = $rtoi($ceil(fs*delayTime_29));
parameter n_delta_address_30 = $rtoi($ceil(fs*delayTime_30));
parameter n_delta_address_31 = $rtoi($ceil(fs*delayTime_31));
parameter n_delta_address_32 = $rtoi($ceil(fs*delayTime_32));
parameter n_delta_address_33 = $rtoi($ceil(fs*delayTime_33));
parameter n_delta_address_34 = $rtoi($ceil(fs*delayTime_34));
parameter n_delta_address_35 = $rtoi($ceil(fs*delayTime_35));
parameter n_delta_address_36 = $rtoi($ceil(fs*delayTime_36));
parameter n_delta_address_37 = $rtoi($ceil(fs*delayTime_37));
parameter n_delta_address_38 = $rtoi($ceil(fs*delayTime_38));
parameter n_delta_address_39 = $rtoi($ceil(fs*delayTime_39));
parameter n_delta_address_40 = $rtoi($ceil(fs*delayTime_40));
