...
HD_PWD='C:/Users/12289/Desktop/Coding/FPGA/Compressed_DCS_TROPICS/Compressed_DCS_TROPICS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AutoCorrelator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AutoCorrelator.tcl
